...
from htbuilder import HtmlElement, div, span, styles # >3.7
from htbuilder.units import px, rem, em, percent
...
def annotated_text(*args, height_iframe=500):
    ...
    *args : str, tuple or htbuilder.HtmlElement
    ...
    streamlit.components.v1.html(str(out), height=height_iframe, scrolling=True)

#----

def annotated_text2(*args, height_iframe=200):
    """Writes test with annotations into your Streamlit app.
